...
\end{document}
# Review changes and divergence
git status

# Add untracked files to staging area if necessary
git add <file>

# Commit changes
git commit -m "Message describing the changes"

# Pull changes from the remote branch if needed
git pull origin main

# Push local changes to the remote branch if needed
